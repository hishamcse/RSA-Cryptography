...
public class Controller {
    ...
    public void description() {
        ...
        fxmlLoader.setLocation(getClass().getResource("InstructMultGenerate/instruction.fxml"));
        try {
    ...
    public void generate() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("InstructMultGenerate/generator.fxml"));
        try {
            dialog.getDialogPane().setContent(fxmlLoader.load());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void multiplication() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("InstructMultGenerate/multiplication.fxml"));
        try {
            dialog.getDialogPane().setContent(fxmlLoader.load());
        } catch (IOException e) {
            e.printStackTrace();
